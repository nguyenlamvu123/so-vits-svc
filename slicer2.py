...
def main(lis: list or None = None):
    import os.path
    ...
    args = parser.parse_args() if lis is None else parser.parse_args((lis))
    out = args.out
    if out is None:
...
if __name__ == '__main__':
    main(
        ['--out', '/home/zaibachkhoa/Downloads/bolomotnguoi/', "/home/zaibachkhoa/Downloads/bolomotnguoi.wav"]
    )
